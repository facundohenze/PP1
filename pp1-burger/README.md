...
| GET     | `/api/pedidos/:idPedido/productos/:idPedidoProducto` | Obtener detalle de un producto específico en un pedido |
| GET     | `/api/pedidos/estadisticas/resumen`      | Obtener estadísticas de pedidos |
